...
class DynamixelControlNode(Node):
    ...
    def process(self):
        ...
        time.sleep(3.0)
        # 각도(deg)로 변환 후 모터 회전
        self.motor2.move(180 - joint_angles_deg[1])
        self.ax_motor1.move(150 + joint_angles_deg[2])
        self.motor1.move(180 - joint_angles_deg[3])
        self.ax_motor2.move(150 + joint_angles_deg[4])
        time.sleep(5.0)
